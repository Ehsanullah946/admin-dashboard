        ...
        >
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl">$930,3242</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780">
          ...
          <div className="flex  mt-10  gap-10 flex-wrap justify-center">
            <div className="border-r-1 border-color m-4 pr-10 ">
              <div>
                <p>
                  <span className="text-3xl font-semibold">$323,908</span>
                  <span
                    className="p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full text-white bg-green-400 ml-3
                  text-xs"
                  >
                    23%
                  </span>
              ...
              <div className="mt-8 ">
                <p>
                  <span className="text-3xl font-semibold">$564,908</span>
                </p>
